...
import { 
  Shield, LayoutDashboard, SearchCheck, Settings, Sparkles, 
  Crosshair, Sun, Moon 
} from 'lucide-react';
          ...
          >
            ...
            <div>
              <div className="flex items-center space-x-2">
                <span className="font-headline font-extrabold text-xl tracking-tight text-slate-900 dark:text-white group-hover:text-green-700 dark:group-hover:text-[#97d700] transition">
                  SHER<span className="text-[#00E5FF]">DETECT</span>
                </span>
                <span className="px-2 py-0.5 text-[9px] font-mono font-extrabold rounded-full bg-green-100 text-green-800 border border-green-300 dark:bg-[#97d700]/15 dark:text-[#97d700] dark:border-[#97d700]/40">
                  AI FORENSIC
                </span>
              </div>
